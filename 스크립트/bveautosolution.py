...
class SolutionRunner:
    ...
    def load_info(self):
        ...
        self.brokenchain = get_float_input('파정 입력 : ')
        self.offset = get_float_input('오프셋 입력 : ')
    ...
    def create_km_post(self):
        ...
        try:
            ...
            # 구조물 측점 파정처리
            self.structure_list = apply_brokenchain_to_structure(self.structure_list, self.brokenchain)
